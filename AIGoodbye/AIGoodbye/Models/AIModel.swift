...
extension AIModel {
    // Qwen2.5 7B with Q2_K quantization - smaller memory footprint
    static let qwen7B = AIModel(
        id: "qwen-7b",
        name: "Qwen 7B",
        shortDescription: "Powerful multilingual AI assistant",
        fullDescription: "Qwen2.5 7B Instruct with Q2_K quantization for mobile compatibility. Excellent multilingual support.",
        size: "2.7 GB",
